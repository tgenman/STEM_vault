...
- Word Embeddings: Dense vector representation of words (e.g., [[Word2Vec]], [[GloVe]], FastText).
- Sentence Embeddings: Vector representation of entire sentences or paragraphs (e.g., [[BERT]], Sentence-BERT).
