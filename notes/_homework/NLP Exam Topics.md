...
13. Neural language modeling. Problem setup, key architectures (GPT-based or analogous). Quality metrics for LM.
14. Transfer learning paradigm. T5, instruction-tuning (T0).
15. Generative pretraining. Large language models. Basic LLM adaptation (zero-shot, few-shot prompting).
16. Transfer Learning with LLMs
17. Learning from human feedback for LLMs. RLHF. PPO & DPO.
18. LLM alignment
