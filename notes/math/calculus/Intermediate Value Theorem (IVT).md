...
START
math_complex
FRONT: Intermediate Value Theorem (IVT)
BACK: While the [[Extreme Value Theorem (EVT)]]  says something about maximum (and minimum) values, the ==Intermediate Value Theorem== says something about the values in between.
