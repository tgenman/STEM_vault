...
START
Math prop
Question_eng: Z-преобразования
Question_rus: 
Answer_eng: это статистический метод, используемый для преобразования данных из [[Normal distribution|Нормального распределения]]  с любым [[Mean|средним значением]]  (µ) и [[Среднеквадратичное отклонение|стандартным отклонением]]  (σ) в [[Стандартное нормальное распределение]] с средним, равным 0, и стандартным отклонением, равным 1. 
Answer_rus: 
