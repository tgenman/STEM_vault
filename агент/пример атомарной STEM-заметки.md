...
Это полный образец новой понятийной заметки с карточкой Anki. Он показывает совместную структуру элементов, но не заменяет `templates/УН (template).md`, локальный MOC, источник и актуальный Anki-протокол.
